...
namespace HexWars.NetServer.Operations
{
    ...
    public static class SafeLogging
    {
        ...
        /// <summary>For framework APIs that later log an exception themselves. Never retain the original
        /// as InnerException: console providers render the entire exception chain.</summary>
        public static Exception RedactedException(Exception failure) =>
            new InvalidOperationException(SteamLogRedaction.Describe(failure));
