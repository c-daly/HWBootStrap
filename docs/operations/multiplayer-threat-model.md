...
```
  ...
  |                                                                                 |
  |  CORS -> rate limiter -> request limits -> endpoints                            |
