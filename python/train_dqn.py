"""Deprecated compatibility wrapper for experimental masked DQN training."""
...
def main() -> None:
    ...
    parser.add_argument("--out", default="hexwars_dqn")
    parser.add_argument("--logdir", default=None)
    parser.add_argument("--server", default=os.environ.get("HEXWARS_SERVER", DEFAULT_DLL))
    parser.add_argument("--checkpoint-freq", type=int, default=10_000)
    args = parser.parse_args()

    print("DEPRECATED: use hexwars_ml.py train --algorithm masked_dqn")
    print("WARNING: masked DQN remains experimental; MaskablePPO is the verified default")
